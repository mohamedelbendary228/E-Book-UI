import 'package:ebook/widgest/book_info_details.dart';
import 'package:ebook/widgest/books_you_may_like_also.dart';
import 'package:ebook/widgest/chapters_card.dart';
import 'package:flutter/cupertino.dart';
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';

import '../provider/book_chapters.dart';
...
class BookDetailsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final bookChapters =
        Provider.of<BookChaptersProvider>(context).chapterItems;
